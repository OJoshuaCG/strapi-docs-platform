...
export interface ApiDocumentationArticleDocumentationArticle
  ...
  info: {
    description: 'Technical documentation articles with multilingual support';
...
export interface ApiDocumentationCategoryDocumentationCategory
  ...
  info: {
    description: 'Categories for grouping documentation articles';
...
export interface ApiDocumentationSpaceDocumentationSpace
  extends Struct.CollectionTypeSchema {
  collectionName: 'documentation_spaces';
  info: {
    description: 'Espacio de documentaci\u00F3n independiente. Cada instancia agrupa sus propias categor\u00EDas y art\u00EDculos.';
